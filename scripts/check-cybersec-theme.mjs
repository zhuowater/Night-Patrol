...
const requiredSnippets = [
  ...
  { file: 'src/game/engine/core.ts', text: 'applyAttackChainPressure' },
  { file: 'src/game/engine/core.ts', text: 'C2 信标回连' },
  { file: 'src/game/engine/core.ts', text: '横向移动扩大落点' },
  { file: 'src/game/engine/core.ts', text: '凭据喷洒污染抽牌' },
  { file: 'src/game/engine/core.ts', text: '勒索倒计时' },
  ...
  { file: 'src/game/engine/core.ts', text: 'recordAttackChainInterruption' },
  { file: 'src/game/engine/core.ts', text: '主动打断' },
  ...
  { file: 'src/game/engine/core.ts', text: 'applyAttackChainCounterplay' },
  { file: 'src/game/engine/core.ts', text: 'C2 追踪拦截' },
  { file: 'src/game/engine/core.ts', text: '凭据隔离清洗' },
  { file: 'src/game/engine/core.ts', text: '勒索恢复演练' },
];
