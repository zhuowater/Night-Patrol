...
const files = [
  ...
  'src/App.tsx',
  'src/ui/title-screens.tsx',
  'src/ui/screens/RunScreens.tsx',
  'src/ui/screens.tsx',
  'src/ui/screens/CombatIntelPanel.tsx',
  'src/styles.css',
...
const requiredSnippets = [
  ...
  { file: 'src/ui/title-screens.tsx', text: 'zhuowater × Hermes 联合开发' },
  { file: 'src/ui/screens/RunScreens.tsx', text: '取证价值' },
  { file: 'src/ui/screens/RunScreens.tsx', text: '战术代价' },
  { file: 'src/ui/screens/RunScreens.tsx', text: '情报报价单' },
  { file: 'src/ui/screens/RunScreens.tsx', text: '清理误报规则' },
  { file: 'src/ui/screens/RunScreens.tsx', text: '异常事件 · 值班研判' },
  { file: 'src/ui/screens/RunScreens.tsx', text: '研判信号' },
  { file: 'src/ui/screens/RunScreens.tsx', text: '维护窗口 · 变更评审' },
  { file: 'src/ui/screens/RunScreens.tsx', text: '变更影响' },
  { file: 'src/ui/screens/CombatIntelPanel.tsx', text: '攻击链态势' },
  { file: 'src/ui/screens/CombatScreen.tsx', text: '建议响应' },
  { file: 'src/ui/screens/CombatIntelPanel.tsx', text: '术语解释' },
  { file: 'src/ui/screens/CombatIntelPanel.tsx', text: 'IOC：标记后可被沙箱引爆' },
  ...
  { file: 'src/ui/screens/CombatIntelPanel.tsx', text: '推荐反制' },
  ...
  { file: 'src/game/engine/attackChain.ts', text: '链路风险预告' },
  { file: 'src/game/engine/attackChain.ts', text: '下次信标' },
  { file: 'src/game/engine/attackChain.ts', text: '抽牌污染' },
  { file: 'src/ui/screens/CombatIntelPanel.tsx', text: '勒索倒计时' },
  { file: 'src/game/engine/attackChain.ts', text: '横移失控' },
  ...
  { file: 'src/ui/screens/CombatIntelPanel.tsx', text: '主动打断反馈' },
  { file: 'src/ui/screens/CombatIntelPanel.tsx', text: '最近压制' },
  { file: 'src/ui/screens/CombatIntelPanel.tsx', text: '反制窗口' },
  { file: 'src/game/engine/attackChain.ts', text: 'C2：IOC ≥ 1 可拦截信标' },
